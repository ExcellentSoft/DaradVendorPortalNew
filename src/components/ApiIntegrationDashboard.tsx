// components/ApiIntegrationDashboard.tsx
...
const ApiIntegrationDashboard: React.FC = () => {
  return (
    ...
    >
      ...
      >
        {/*
          NOTE: Replace '/rocket-icon.svg', '/monitor-key-icon.svg', and '/pin-icon.svg'
          with the actual paths to your SVG icons in your 'public' folder or wherever
          you store your static assets. For example:
          <img src="/icons/rocket-icon.svg" alt="Rocket Icon" className="h-5 w-5" aria-hidden="true" />
        */}

        <div className="flex flex-col items-center flex-1 justify-center w-full h-full">
          {/* Div for Rocket Icon and Title text */}
          <div className="flex items-center gap-x-[4px]">
            <img src="/rocket-icon.svg" alt="Rocket Icon" className="h-5 w-5" aria-hidden="true" />
            <h2
      ...
      {/* API Keys Management */}
      <div className="mb-8 px-6 flex flex-col gap-2">
        <div
          className="flex flex-col justify-center items-start gap-[12px]"
          style={{ width: '355px', height: '76px' }}
        >
          <div className="flex items-center">
            <img src="/monitor-key-icon.svg" alt="API Keys Icon" className="h-5 w-5 mr-2" aria-hidden="true" />
            <h3
        ...
        {/* Wrapper DIV for table and button with 8px internal gap */}
        <div className="flex flex-col gap-4 mt-2">
          <div className="overflow-x-auto rounded-[16px] overflow-hidden">
        ...
        {/* Webhook Management */}
        {/* Changed to flex container with column direction and center alignment */}
        <div
          className="mb-8 px-6"
          style={{
            display: 'flex',
