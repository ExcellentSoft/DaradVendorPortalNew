...
import { CheckCircle, XCircle, Clock, Search, CalendarDays, FileDown, MoreHorizontal } from 'lucide-react';
    ...
    <div className="p-4 space-y-4">
      <div className="bg-white p-4 rounded-lg shadow flex flex-col gap-4">
        ...
        <select className="border  border-gray-100 rounded-md px-3 py-1.5 text-sm text-[#121212]">
          ...
          <button className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium px-4 py-1.5 rounded-md">
