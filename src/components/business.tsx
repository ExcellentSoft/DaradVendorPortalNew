        ...
        <div className="flex flex-col items-center mb-6 relative">
          <div className="w-20 h-20 bg-gray-200 rounded-full flex items-center justify-center overflow-hidden relative">
            ...
            <FiEdit2
              ...
              className="absolute bottom-1 right-1 text-purple-600 bg-white rounded-full p-1 w-5 h-5 cursor-pointer"
            />
            <input
              type="file"
              accept="image/*"
          ...
          <div className="flex items-center border border-gray-300 rounded-md overflow-hidden w-full">
            ...
            <input
              ...
              className={`px-3 py-4 text-sm text-[#121212] outline-none ${
                isEditingPhone ? "bg-white text-[#121212]" : "cursor-not-allowed"
              }`}
