...
interface Product {
  ...
  name: string;
  description: string;
  price: string; // Using string for price as per image (e.g., "7,500")
  isActive: boolean;
}
...
const ProductShowcase: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
      ...
      {/* Tabs Menu Section - White Background, separated from the header */}
          ...
          {['Logo', 'Gift Items', 'Tutorials', 'Phone Number', 'Digital Courses'].map((tab) => (
            <button
              ...
              className={`flex-shrink-0 px-4 py-2 text-sm font-medium transition-colors duration-200 ${
                activeTab === tab
                  ? 'text-purple-700 border-b-2 border-purple-700' // Purple font and purple underline
                  : 'text-gray-700 hover:text-purple-700 hover:bg-gray-100 rounded-lg' // Inactive state with rounded corners
              }`}
      ...
      <div className="px-4 py-6">
        ...
        {/* Save & Continue Button - Inside the main content area, centered */}
