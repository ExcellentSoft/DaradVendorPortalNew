...
<div className="bg-white p-6 rounded-2xl min-h-[150px] flex flex-col items-center justify-center text-center">
            ...
            <p className="font-inter font-normal text-[14px] leading-[100%] tracking-[1%] text-center capitalize text-black text-center">Total Amount</p>
            <p className="font-inter font-normal text-[14px] leading-[100%] tracking-[1%] text-center capitalize text-black text-center">Deposited</p>
          </div>
        <div className="bg-white p-6 rounded-2xl min-h-[150px] flex flex-col items-center justify-center text-center">

            <p className="font-inter font-normal text-[14px] leading-[100%] tracking-[1%] text-center capitalize text-black text-center">Total Amount</p>
            <p className="font-inter font-normal text-[14px] leading-[100%] tracking-[1%] text-center capitalize text-black text-center">Transferred</p>
          </div>
         <div className="bg-white p-6 rounded-2xl min-h-[150px] flex flex-col items-center justify-center text-center">

            <p className="font-inter font-normal text-[14px] leading-[100%] tracking-[1%] text-center capitalize text-black text-center">Pending Monthly</p>
            <p className="font-inter font-normal text-[14px] leading-[100%] tracking-[1%] text-center capitalize text-black text-center">Maintainance Fee</p>
          </div>
        </div>
      </div>
