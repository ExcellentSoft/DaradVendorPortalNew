  ...
  return (
    <div className="relative w-full h-full top-[70px] rounded-[12px] bg-white shadow-lg p-6 pb-10">
      ...
      <div className=" h-[119px] bg-white px-5 pt-6 pb-3 space-y-[10px] border-b border-b-[#1212121A] text-center">
        <h2 className="text-center font-semibold text-[24px] leading-[100%] tracking-normal capitalize font-urbanist text-black">create gift item category</h2>
        <p className="text-center font-normal text-[14px] leading-[160%] tracking-normal text-[#121212CC] font-inter">
          Set up a category to showcase your unique gift  <br />items.
        </p>
      </div>
    ...
    <span className="text-[#5604F6] font-medium">₦500</span> processing fee applies for each  gift category created
  </p>
      </div>
      ...
      <div className="mt-10">
        <div>
          <label className="font-inter font-medium text-[14px] leading-[100%] align-middle capitalize text-[#101928]">gift item category</label>
          <input
            type="text"
            placeholder="enter gift item category name"
