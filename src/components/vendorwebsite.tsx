    ...
    <div className="min-h-screen bg-white w-full">
      ...
      <header className="border-b rounded-b py-4 px-6 gap-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-[#121212CC]">
            Customize your store, add products, import orders & setup and start selling in minutes.
          </p>
        </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {preview ? (
                      <div className="relative w-full h-48 border border-gray-300 rounded-lg overflow-hidden">
                        ...
                        <div className="absolute top-2 right-2 flex flex-col space-y-2">
                          ...
                          <label
                            className="bg-white p-1 rounded shadow hover:bg-gray-100 cursor-pointer"
                            title="Replace"
                          >
                      ...
                      <label className="block w-full h-48 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer flex items-center justify-center relative overflow-hidden">
                        ...
                        <div className="flex flex-col items-center text-center">
                          ...
                          <p className="text-xs text-gray-400 mt-1">
                            Format: .jpg, .jpeg, .png, .svg | Max size: 25 MB
                          </p>
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      className={`w-full p-2 border ${
                        errors.storeName ? 'border-red-500' : 'border-[#1E015680]'
                      } rounded-md`}
                      value={storeName}
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      className={`w-full p-2 border ${
                        errors.businessEmail ? 'border-red-500' : 'border-[#1E015680]'
                      } rounded-md`}
                      value={businessEmail}
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      className={`w-full p-2 border ${
                        errors.phoneNumber ? 'border-red-500' : 'border-[#1E015680]'
                      } rounded-md`}
                      value={phoneNumber}
                  ...
                  <div className="mb-4">
                    <label
                      className="block text-black text-md font-semibold mb-1"
                    ...
                    <textarea
                      ...
                      className={`w-full p-2 border ${
                        errors.storeDescription ? 'border-red-500' : 'border-[#1E015680]'
                      } rounded-md`}
                  ...
                  <div className="flex justify-between">
                    <button
                      type="button"
                      className="px-6 py-2 text-[#5604F6] border border-[#E6D9FE] rounded-md"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      className="px-6 py-2 bg-[#5604F6] text-white rounded-md disabled:opacity-50"
                    >
                      Save & Continue
                    </button>
                  </div>
